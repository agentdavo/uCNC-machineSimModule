...
static enum stlioError callbackError(
	...
	printf("Parser encountered error %s (code %u) at line %lu:%lu or offset %lu\n", stlioErrorStringC(eCode), eCode, dwLineNumber, dwLineChar, dwByteOffset);
